 ...
 * @description Singleton Conexion BD RRHH
 */
public class RrhhConf {
	...
	private final static String _url = "jdbc:mysql://" + Configuraciones.getConfig("bd.server") + "/" + Configuraciones.getConfig("bd.rrhh");
