			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="row placeholders">
					<div class="col-xs-6 col-sm-3 placeholder">
						<img data-src="holder.js/200x200/text:${cantidadProductos }/sky" class="img-responsive"
							alt="200x200"
					...
					<div class="col-xs-6 col-sm-3 placeholder">
						<img data-src="holder.js/200x200/text:${cantidadOrdenes }/vine" class="img-responsive"
							alt="200x200"
							...
							data-holder-rendered="true">
						<h4>Cantidad Ordenes</h4>
					</div>
					<div class="col-xs-6 col-sm-3 placeholder">
						<img data-src="holder.js/200x200/text:${cantidadClientes}/sky" class="img-responsive"
							alt="200x200"
							src="data:image/svg+xml;base64,"
							data-holder-rendered="true">
					...
					<div class="col-xs-6 col-sm-3 placeholder">
						<img data-src="holder.js/200x200/text:${cantidadOrdenesProducto}/vine" class="img-responsive"
							alt="200x200"
							src="data:image/svg+xml;base64,"
							data-holder-rendered="true">
						<h4>Cantidad Ordenes Producto</h4>
					</div>
				</div>
			</div>
		</div>
